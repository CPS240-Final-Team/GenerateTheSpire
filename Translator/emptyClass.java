public class iron_wave extends AbstractCard {
	private static final Cardstring cardStrings = "Gain %b block";
	public static final String ID = "iron_wave";
	public iron_wave() {
		super("iron_wave", "Iron Wave", "RED/ATTACK/Iron Wave", 1, "Gain %b block", AbstractCard.CardType.ATTACK, AbstractCard.CardColor.RED, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.ENEMY);
		this.baseBlock = 5;
